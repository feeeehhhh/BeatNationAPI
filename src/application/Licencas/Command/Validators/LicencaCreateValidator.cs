...
// namespace src.application.Licencas.Command.Validators
// {
//     public class LicencaCreateValidator : AbstractValidator<LicencaCreateRequest>
//     {
//         public LicencaCreateValidator()
//         {
//             RuleFor(x => x.Nome)
