...
namespace BeatNationAPI.Migrations
{
    ...
    [Migration("20260524210728_AddRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeatNationAPI.Models.License", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BeatNationAPI.Models.LicenseAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BeatNationAPI.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BeatNationAPI.Models.User", b =>
                {
            ...
            modelBuilder.Entity("BeatNationAPI.Models.LicenseAssignment", b =>
                {
                    ...
                    b.HasOne("BeatNationAPI.Models.License", "Licencas")
                        .WithMany()
            ...
            modelBuilder.Entity("BeatNationAPI.Models.RefreshToken", b =>
                {
                    b.HasOne("BeatNationAPI.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BeatNationAPI.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
